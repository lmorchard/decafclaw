...
# Combined registry
TOOLS = {**CORE_TOOLS, **TABSTACK_TOOLS, **MEMORY_TOOLS, **TODO_TOOLS}
TOOL_DEFINITIONS = CORE_TOOL_DEFINITIONS + TABSTACK_TOOL_DEFINITIONS + MEMORY_TOOL_DEFINITIONS + TODO_TOOL_DEFINITIONS
