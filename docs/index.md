...
- [Code Execution](code-execution.md) — Programmatic tool calling: run a Python script in an isolated subprocess that drives a curated set of decafclaw tools, returning only what the script prints
